                        ...
                        @else
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    @if ($invoice->status == 'validation error 1')
                                        <td class="px-4 py-2 bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 text-center">
                                            No monthly estimation found
                                        </td>
                                    @endif
                                    @if ($invoice->status == 'validation error 2')
                                        <td class="px-4 py-2 bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 text-center">
                                            Monthly estimation found to be 0 or lower
                                        </td>
                                    @endif
                                    @if ($invoice->status == 'validation error 3')
                                        <td class="px-4 py-2 bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 text-center">
                                            No consumption data found
                                        </td>
                                    @endif
                                    @if ($invoice->status == 'validation error 1' || $invoice->status == 'validation error 2' || $invoice->status == 'validation error 3')
                                        <td class="px-4 py-2 bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 text-center">
